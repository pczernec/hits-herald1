...
class HiTSNode(Node):
    ...
    def __init__(self, name, parents, subtask_spec, HiTS_kwargs, tb_writer = None):
        ...
        add_experience_to_parent_every_step = HiTS_kwargs.pop('add_experience_to_parent_every_step', False)
        ...
        self._add_experience_to_parent_every_step = add_experience_to_parent_every_step
