...
class TimedGoalSubtask(Subtask):
    ...
    def get_action_time(self, action):
        return self.task_spec.unconvert_time(action["delta_t_ach"])
    ...
    def evaluate_transition(self, env_obs, env_info, subtask_trans, parent_info, algo_info, sess_info, child_info):
    ...
    def get_updated_desired_tg_in_steps(self, env_obs, parent_info, sess_info):
        ...
        desired_tg.delta_t_ach = (
            self.task_spec.unconvert_time(desired_tg.delta_t_ach) - elapsed_time
        )
        desired_tg.delta_t_comm = (
            self.task_spec.unconvert_time(desired_tg.delta_t_comm) - elapsed_time
        )
