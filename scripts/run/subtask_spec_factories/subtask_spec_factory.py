...
class SubtaskSpecFactory(ABC):
    ...
    def produce(cls, env, graph_params):
        ...
        # TODO: Later use for herald cls.get_herald_subtask_specs
        alg_to_method_dict = {
                "HiTS": cls.get_hits_subtask_specs,
                "HAC": cls.get_hac_subtask_specs,
                "HERALD": cls.get_hits_subtask_specs
                }
    ...
    @classmethod
    @abstractmethod
    def get_herald_subtask_specs(cls, env, n_layers, subtask_spec_params_list):
        """Get subtask specs for Herald graph from parameters."""
        pass
